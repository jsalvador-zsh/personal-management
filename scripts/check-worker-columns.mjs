 ...
 * Ejecutar con: node scripts/check-worker-columns.mjs
 */
...
async function checkColumns() {
  ...
  try {
    ...
    if (!data || data.length === 0) {
      console.log('⚠️  La tabla workers está vacía, necesitamos verificar de otra forma')
      console.log('   Intenta crear un trabajador de prueba desde la aplicación\n')
    }
